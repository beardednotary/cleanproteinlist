...
const quizData = {
    ...
    proteinSource: '',
    primaryUse: '',
    concernLevel: '',// Store user answers
const quizData = {
    frequency: '',
    currentBrand: '',
    currentBrandName: '',
...
const KIT_API_KEY = 'JoZDa_bAI7YHe7ZAEv4Mrg'; // From Kit Settings > Advanced > API Secret
...
async function submitToKit() {
    ...
    if (KIT_API_KEY === 'JoZDa_bAI7YHe7ZAEv4Mrg' || KIT_FORM_ID === '8692777') {
...
// Kit API Configuration - REPLACE THESE WITH YOUR ACTUAL VALUES
const KIT_API_KEY = 'JoZDa_bAI7YHe7ZAEv4Mrg'; // From Kit Settings > Advanced > API Secret
const KIT_FORM_ID = '6cf1ed408b'; // From Kit form URL
...
async function submitToKit() {
    ...
    // Check API credentials are set
    if (KIT_API_KEY === 'JoZDa_bAI7YHe7ZAEv4Mrg' || KIT_FORM_ID === '6cf1ed408b') {
        console.error('Kit API credentials not set!');
        errorMessage.textContent = 'Configuration error. Please contact support.';
        errorMessage.style.display = 'block';
        return;
